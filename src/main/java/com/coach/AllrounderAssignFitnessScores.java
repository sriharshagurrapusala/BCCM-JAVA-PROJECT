 ...
 */
public class AllrounderAssignFitnessScores extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (allrounderlist != null && !allrounderlist.isEmpty()) {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("assignfitnesstoallrounderplayers.jsp");
